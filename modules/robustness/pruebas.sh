...
python robustness2.py ../../data/realNetworks/Power\ grid/power.gml  power_apl_sequential.png apl False


# Analisis de average path length simultaneo sobre redes grandes

echo ecoli_apl_simultaneus
python robustness2.py ../../data/realNetworks/EColi/EColi.gml ecoli_apl_simultaneus.png apl True

echo email_apl_simultaneus
python robustness2.py ../../data/realNetworks/Email\ network/email.gml email_apl_simultaneus.png apl True

echo power_apl_simultaneus
python robustness2.py ../../data/realNetworks/Power\ grid/power.gml  power_apl_simultaneus.png apl True
